...
function openCustomEventModal() {
  ...
  if (typeof flatpickr !== 'undefined') {
      window._eventEndPicker = flatpickr('#eventEndDate', {
         ...
         allowInput: false,
         disableMobile: true,
         prevArrow: "<svg viewBox='0 0 17 17'><path d='M5.207 8.471l7.146 7.147-0.707 0.707-7.853-7.854 7.854-7.853 0.707 0.707-7.147 7.146z' /></svg>",
         nextArrow: "<svg viewBox='0 0 17 17'><path d='M13.207 8.472l-7.854 7.854-0.707-0.707 7.146-7.146-7.146-7.148 0.707-0.707 7.854 7.854z' /></svg>",
         onOpen: function(selectedDates, dateStr, instance) {
            instance.calendarContainer.classList.add("premium-datepicker");
